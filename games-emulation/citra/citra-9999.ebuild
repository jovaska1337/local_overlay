...
EAPI=6
# EAPI=7 causes missing soname, other compiler warnings and nonfuncitonal binary

inherit xdg cmake-utils git-r3 flag-o-matic
...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="system-boost doc qt5 clang -telemetry -i18n ffmpeg -discord"
