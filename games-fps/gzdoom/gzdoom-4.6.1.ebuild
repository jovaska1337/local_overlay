...
IUSE="debug gtk +non-free openmp zdl-integration"
...
src_install() {
	exeinto /usr/bin
	use zdl-integration && doexe "${FILESDIR}/gzdoom-zdl-helper"

	newicon src/posix/zdoom.xpm "${PN}.xpm"
	make_desktop_entry `usex zdl-integration "gzdoom-zdl-helper" "${PN}"` \
		"GZDoom" "${PN}" "Game;ActionGame"
